...
public class Perch extends Fish implements Species{
	public static int number = 0;
	
	public Perch(int direction, boolean isMale, int zz, int xx, int yy) {
		number++;
		numAnimals++;
		//stamina = stam;
		attackRange = 10;
	...
	public void makeBaby(){
		...
		Actor baby = new Perch(gen.nextInt(6), gen.nextBoolean(), z, x, y);
